...
load("music_emotion_plots.Rdata")
...
load("music_language_plots.Rdata")
...
load("models.Rdata"); load("accuracies.Rdata")
...
Based on the accuracies of the 8 models separately in addition to the accuracies of the first and second ensemble models, I decided to use the second ensemble model as my final model, which takes into account the lda, knn, multinom, Rborist, and rf predictions. The final model accuracy was $\boxed{0.52732}$.
